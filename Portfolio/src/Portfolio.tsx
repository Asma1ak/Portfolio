...
const PROJECTS = [
  ...
  },
  {
    ...
    description:
      "A full-page restaurant website for a casual Dubai bistro — interactive menu with tabs, photo gallery, reservation form, and mobile-responsive layout.",
  ...
  },
  {
    ...
    description:
      "A luxury dark-theme restaurant site for an upscale Dubai fine dining venue — cinematic photo presentation, animated hero, tasting menu with hover effects, and an elegant reservation flow.",
    tech: ["HTML", "CSS", "JavaScript"],
    accent: "#B8973A",
    github: "https://github.com/Asma1ak",
    demo: "/nocturne.html",
